...
---
- Demonstrated experience in JavaScript, HTML5, CSS (React), Java, Git, SQL (Oracle & Postgres), Python, Node.
- Experience extracting and transforming data using Oracle SQL and Posgres.
- Experience developing in React, SASS/SCSS precompilation, NextJS, Material-UI, Semantic-UI MDX-remote, styled components.
...
- Experience with various programming and scripting languages including JavaScript, Java and Python, PHP, C#, batch and bash shell scripts.
- Working experience in a professional Agile environment.
- Utilizes a variety of markup languages to write UIs and web pages.
- Experience with continuous deployment and working in a fast paced system.
